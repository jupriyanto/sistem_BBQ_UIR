...
<head>
    ...
    <title>FAKULTAS KEGURUAN DAN ILMU PENDIDIKAN</title>
...
<body>
    ...
    <h1 class="text-center text-2xl font-semibold whitespace-nowrap dark:text-white mt-20">FAKULTAS KEGURUAN DAN ILMU PENDIDIKAN</h1>
